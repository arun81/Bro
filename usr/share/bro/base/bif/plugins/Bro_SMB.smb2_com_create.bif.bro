# This file was automatically generated by bifcl from /build/securityonion-bro-bmYGD9/securityonion-bro-2.5.5/src/analyzer/protocol/smb/smb2_com_create.bif (plugin mode).
...
export {
global smb2_create_request: event(c: connection , hdr: SMB2::Header , file_name: string );
...
global smb2_create_response: event(c: connection , hdr: SMB2::Header , file_id: SMB2::GUID , size: count , times: SMB::MACTimes , attrs: SMB2::FileAttrs );
